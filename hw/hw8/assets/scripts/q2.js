// 
// Part 1: Fill in the function unhideLightbox. Afterwards, we will make this 
// function run when a picture is clicked on.
// 

/**
 * Makes lightbox overlay visible, and shows the lightbox pop-up corresponding 
 * to the id
 *
...
function unhideLightbox1() {
	// TODO: Look in q2.html to see what the id for the lightbox div for the 
	// first picture, and call unhideLightbox
	unhideLightbox("doggo1");
}

// TODO: Set the browser to run the function unhideLightbox1 when someone clicks 
// #picture-1
...
// 
// Part 3: Now we need to be able to close the lightbox when we click outside the 
// picture!
// 
...
// This function class closeLightbox() for every .lightbox div - feel free to read 
// it, but you do not have to understand it completely!
function closeAllLightboxes() {
	// get every .lightbox div, getElementsByClassName gives us an array 
	var lightboxElements = document.getElementsByClassName('lightbox');

	// sneak preview of Javascript loops, which will go through every element in 
...
// TODO: set the closeAllLightboxes function to run when #lightbox-overlay is 
// clicked on.
