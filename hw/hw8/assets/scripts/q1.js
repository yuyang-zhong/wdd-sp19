...
//
// Part 1: Code setBackgroundColor() so the background color of #q1-container 
// changes to the color specified
//
...
function setBackgroundColor(color) {
    // TODO: Get the element with the id "q1-container" and set its background 
    // color to the input color
    document.getElementById("q1-container").style.background = color;
}

//
// Part 2: Code the function redButtonClicked() and make the browser run the 
// function for you when #q1-btn-red is clicked
//

// For the red button
// Use the color #EF476F, or change it up to your liking
// If you do decide to change the color, probably also consider updating the 
// corresponding button color in CSS :)

/**
 * Handler function that the browser should run when the red button is clicked
 */
function redButtonClicked() {
    // TODO: Use the setBackgroundColor() to set the background color to #EF476F 
    // (or another color of your choice)
    setBackgroundColor("#EF476F");
}

// This gets the element with id "q1-btn-red" and sets the browser to run the 
// function redButtonClicked() when someone clicks the element
document.getElementById("q1-btn-red").onclick = redButtonClicked;

// After you finish part 1 & 2, the clicking the red button should turn the 
...
// TODO: Set the browser to run the function yellowButtonClicked() when someone 
// clicks #q1-btn-yellow
